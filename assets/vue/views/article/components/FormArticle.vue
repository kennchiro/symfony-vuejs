    ...
    export default {
        ...
        mounted() {
            if(this.article != null){
              ...
              //
                this.selectedCategory = this.article.category.id
            }else {
                this.selectedAuthor = this.authors[0].id
              //
                this.selectedCategory = this.categorys[0].id
            }
        },
        beforeDestroy() {
            let editor = this.$refs['editor']
        ...
        methods:{
            ...
            async saveArticle(){
                ...
                //
                const category = this.categorys.find(item => item.id == this.selectedCategory)
