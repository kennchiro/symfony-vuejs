...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getArticleControllerService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\src\\Manager\\BaseManager.php';
        include_once \dirname(__DIR__, 4).'\\src\\Manager\\ArticleManager.php';

        $this->services['App\\Controller\\ArticleController'] = $instance = new \App\Controller\ArticleController(new \App\Manager\ArticleManager(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), $this, ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), ($this->services['session'] ?? $this->getSessionService()), ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()), ($this->services['serializer'] ?? $this->getSerializerService()), ($this->privates['App\\Repository\\ArticleRepository'] ?? $this->getArticleRepositoryService()), ($this->privates['App\\Repository\\AuthorRepository'] ?? $this->getAuthorRepositoryService()), ($this->privates['App\\Repository\\CommentRepository'] ?? $this->getCommentRepositoryService()), ($this->privates['App\\Repository\\CategoryRepository'] ?? $this->getCategoryRepositoryService())));
    ...
    protected function getAuthorControllerService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\src\\Manager\\BaseManager.php';
        include_once \dirname(__DIR__, 4).'\\src\\Manager\\AuthorManager.php';

        $this->services['App\\Controller\\AuthorController'] = $instance = new \App\Controller\AuthorController(new \App\Manager\AuthorManager(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), $this, ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), ($this->services['session'] ?? $this->getSessionService()), ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()), ($this->services['serializer'] ?? $this->getSerializerService()), ($this->privates['App\\Repository\\AuthorRepository'] ?? $this->getAuthorRepositoryService())));

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\AuthorController', $this));
    ...
    protected function getCarControllerService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\src\\Manager\\BaseManager.php';
        include_once \dirname(__DIR__, 4).'\\src\\Manager\\CarManager.php';

        $this->services['App\\Controller\\CarController'] = $instance = new \App\Controller\CarController(new \App\Manager\CarManager(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), $this, ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), ($this->services['session'] ?? $this->getSessionService()), ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()), ($this->services['serializer'] ?? $this->getSerializerService()), ($this->privates['App\\Repository\\CarRepository'] ?? $this->getCarRepositoryService())));

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\CarController', $this));
    ...
    protected function getCategoryControllerService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\src\\Manager\\BaseManager.php';
        include_once \dirname(__DIR__, 4).'\\src\\Manager\\CategoryManager.php';

        $this->services['App\\Controller\\CategoryController'] = $instance = new \App\Controller\CategoryController(new \App\Manager\CategoryManager(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), $this, ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), ($this->services['session'] ?? $this->getSessionService()), ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()), ($this->services['serializer'] ?? $this->getSerializerService()), ($this->privates['App\\Repository\\CategoryRepository'] ?? $this->getCategoryRepositoryService())));
    ...
    protected function getCommentControllerService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\src\\Manager\\BaseManager.php';
        include_once \dirname(__DIR__, 4).'\\src\\Manager\\CommentManager.php';

        $this->services['App\\Controller\\CommentController'] = $instance = new \App\Controller\CommentController(new \App\Manager\CommentManager(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), $this, ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), ($this->services['session'] ?? $this->getSessionService()), ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()), ($this->services['serializer'] ?? $this->getSerializerService()), ($this->privates['App\\Repository\\CommentRepository'] ?? $this->getCommentRepositoryService()), ($this->privates['App\\Repository\\ArticleRepository'] ?? $this->getArticleRepositoryService())));

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\CommentController', $this));
    ...
    protected function getLivreControllerService()
    {
        ...
        include_once \dirname(__DIR__, 4).'\\src\\Manager\\BaseManager.php';
        include_once \dirname(__DIR__, 4).'\\src\\Manager\\LivreManager.php';

        $this->services['App\\Controller\\LivreController'] = $instance = new \App\Controller\LivreController(new \App\Manager\LivreManager(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), $this, ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), ($this->services['session'] ?? $this->getSessionService()), ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()), ($this->services['serializer'] ?? $this->getSerializerService()), ($this->privates['App\\Repository\\LivreRepository'] ?? $this->getLivreRepositoryService())));

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\LivreController', $this));
     ...
     */
    protected function getRootControllerService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Controller\\AbstractController.php';
        include_once \dirname(__DIR__, 4).'\\src\\Controller\\RootController.php';

        $this->services['App\\Controller\\RootController'] = $instance = new \App\Controller\RootController(($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())));

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\RootController', $this));
    ...
    protected function getUserControllerService()
    {
        ...
        $this->services['App\\Controller\\UserController'] = $instance = new \App\Controller\UserController(new \App\Manager\UserManager(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), $this, ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), ($this->services['session'] ?? $this->getSessionService()), ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()), ($this->services['serializer'] ?? $this->getSerializerService()), ($this->privates['App\\Repository\\UserRepository'] ?? $this->getUserRepositoryService()), ($this->services['lexik_jwt_authentication.jwt_manager'] ?? $this->getLexikJwtAuthentication_JwtManagerService()), ($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService())));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('bM59QE0hgU', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DNkm8iDvSc', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getCache_SystemClearerService()
    {
        ...
        return $this->services['cache.system_clearer'] = new \Symfony\Component\HttpKernel\CacheClearer\Psr6CacheClearer(['cache.system' => ($this->services['cache.system'] ?? $this->getCache_SystemService()), 'cache.validator' => ($this->privates['cache.validator'] ?? $this->getCache_ValidatorService()), 'cache.serializer' => ($this->privates['cache.serializer'] ?? $this->getCache_SerializerService()), 'cache.annotations' => ($this->privates['cache.annotations'] ?? $this->getCache_AnnotationsService()), 'cache.property_info' => ($this->privates['cache.property_info'] ?? $this->getCache_PropertyInfoService()), 'cache.security_expression_language' => ($this->privates['cache.security_expression_language'] ?? $this->getCache_SecurityExpressionLanguageService()), 'cache.webpack_encore' => ($this->privates['cache.webpack_encore'] ?? $this->getCache_WebpackEncoreService()), 'api_platform.cache.route_name_resolver' => ($this->privates['api_platform.cache.route_name_resolver'] ?? $this->getApiPlatform_Cache_RouteNameResolverService()), 'api_platform.cache.identifiers_extractor' => ($this->privates['api_platform.cache.identifiers_extractor'] ?? $this->getApiPlatform_Cache_IdentifiersExtractorService()), 'api_platform.cache.subresource_operation_factory' => ($this->privates['api_platform.cache.subresource_operation_factory'] ?? $this->getApiPlatform_Cache_SubresourceOperationFactoryService()), 'api_platform.cache.metadata.resource' => ($this->privates['api_platform.cache.metadata.resource'] ?? $this->getApiPlatform_Cache_Metadata_ResourceService()), 'api_platform.cache.metadata.property' => ($this->privates['api_platform.cache.metadata.property'] ?? $this->getApiPlatform_Cache_Metadata_PropertyService())]);
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d->addEventListener([0 => 'onFlush'], 'api_platform.doctrine.listener.mercure.publish');
        $d->addEventListener([0 => 'postFlush'], 'api_platform.doctrine.listener.mercure.publish');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\AuthorRepository' => ['privates', 'App\\Repository\\AuthorRepository', 'getAuthorRepositoryService', false],
    ...
    /**
     * Gets the private '.messenger.handler_descriptor.eYX89CA' shared service.
     *
     * @return \Symfony\Component\Messenger\Handler\HandlerDescriptor
     */
    protected function get_Messenger_HandlerDescriptor_EYX89CAService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\symfony\\messenger\\Handler\\HandlerDescriptor.php';

        return $this->privates['.messenger.handler_descriptor.eYX89CA'] = new \Symfony\Component\Messenger\Handler\HandlerDescriptor(($this->privates['mercure.hub.default.publisher.traceable'] ?? $this->getMercure_Hub_Default_Publisher_TraceableService()), []);
    }
    ...
    /**
     * Gets the private '.service_locator.NwOEYjI' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_NwOEYjIService()
    {
        return $this->privates['.service_locator.NwOEYjI'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    /**
     * Gets the private '.service_locator.vopeztb' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_VopeztbService()
    {
        return $this->privates['.service_locator.vopeztb'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\UserController::userUpdate' => ['privates', '.service_locator.NwOEYjI', 'get_ServiceLocator_NwOEYjIService', false],
            'App\\Controller\\UserController:userUpdate' => ['privates', '.service_locator.NwOEYjI', 'get_ServiceLocator_NwOEYjIService', false],
        ], [
    ...
    protected function getArticleRepositoryService()
    {
        ...
        return $this->privates['App\\Repository\\ArticleRepository'] = new \App\Repository\ArticleRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->privates['App\\Repository\\AuthorRepository'] ?? $this->getAuthorRepositoryService()), ($this->privates['App\\Repository\\CommentRepository'] ?? $this->getCommentRepositoryService()));
    }
     ...
     */
    protected function getAuthorRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\persistence\\lib\\Doctrine\\Persistence\\ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\collections\\lib\\Doctrine\\Common\\Collections\\Selectable.php';
        include_once \dirname(__DIR__, 4).'\\vendor\\doctrine\\orm\\lib\\Doctrine\\ORM\\EntityRepository.php';
    ...
    protected function getCategoryRepositoryService()
    {
        ...
        return $this->privates['App\\Repository\\CategoryRepository'] = new \App\Repository\CategoryRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->privates['App\\Repository\\ArticleRepository'] ?? $this->getArticleRepositoryService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('IRgu0dDFqC', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iccURCDTqn', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('t2gvCK3PH-', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.mercure.listener.response.add_link_header'] = new \ApiPlatform\Core\Mercure\EventListener\AddLinkHeaderListener(($this->privates['api_platform.metadata.resource.metadata_factory.cached'] ?? $this->getApiPlatform_Metadata_Resource_MetadataFactory_CachedService()), $this->getEnv('MERCURE_PUBLISH_URL'));
    }
    ...
    {
        return $this->privates['api_platform.metadata.property.name_collection_factory.cached'] = new \ApiPlatform\Core\Metadata\Property\Factory\CachedPropertyNameCollectionFactory(($this->privates['api_platform.cache.metadata.property'] ?? $this->getApiPlatform_Cache_Metadata_PropertyService()), new \ApiPlatform\Core\Metadata\Property\Factory\ExtractorPropertyNameCollectionFactory(($this->privates['api_platform.metadata.extractor.yaml'] ?? ($this->privates['api_platform.metadata.extractor.yaml'] = new \ApiPlatform\Core\Metadata\Extractor\YamlExtractor([0 => (\dirname(__DIR__, 4).'\\config\\api_platform\\user.yaml')], $this))), new \ApiPlatform\Core\Metadata\Property\Factory\ExtractorPropertyNameCollectionFactory(($this->privates['api_platform.metadata.extractor.xml'] ?? ($this->privates['api_platform.metadata.extractor.xml'] = new \ApiPlatform\Core\Metadata\Extractor\XmlExtractor([], $this))), new \ApiPlatform\Core\Metadata\Property\Factory\InheritedPropertyNameCollectionFactory(($this->privates['api_platform.metadata.resource.name_collection_factory.cached'] ?? $this->getApiPlatform_Metadata_Resource_NameCollectionFactory_CachedService()), new \ApiPlatform\Core\Bridge\Symfony\PropertyInfo\Metadata\Property\PropertyInfoPropertyNameCollectionFactory(($this->privates['property_info'] ?? $this->getPropertyInfoService()))))));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ERFGeY4fuV', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('FquKLOyOuU', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('k213MWHlLI', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EW2+AfITyo', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xAvbM4Sa+N', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2mvTM37jAZ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1f6Po+cLY5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getConsole_Command_CachePoolListService()
    {
        ...
        $this->privates['console.command.cache_pool_list'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\CachePoolListCommand([0 => 'cache.app', 1 => 'cache.system', 2 => 'cache.validator', 3 => 'cache.serializer', 4 => 'cache.annotations', 5 => 'cache.property_info', 6 => 'cache.messenger.restart_workers_signal', 7 => 'cache.doctrine.orm.default.metadata', 8 => 'cache.doctrine.orm.default.result', 9 => 'cache.doctrine.orm.default.query', 10 => 'cache.security_expression_language', 11 => 'cache.webpack_encore', 12 => 'api_platform.cache.route_name_resolver', 13 => 'api_platform.cache.identifiers_extractor', 14 => 'api_platform.cache.subresource_operation_factory', 15 => 'api_platform.cache.metadata.resource', 16 => 'api_platform.cache.metadata.property']);
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.vopeztb'] ?? $this->get_ServiceLocator_VopeztbService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
    ...
    protected function getDoctrine_FixturesLoadCommandService()
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\ArticleFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\UserFixture(($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService())), 'groups' => []]]);
    ...
    protected function getMessenger_Bus_Default_Middleware_HandleMessageService()
    {
        ...
        $this->privates['messenger.bus.default.middleware.handle_message'] = $instance = new \Symfony\Component\Messenger\Middleware\HandleMessageMiddleware(new \Symfony\Component\Messenger\Handler\HandlersLocator(['Symfony\\Component\\Mailer\\Messenger\\SendEmailMessage' => new RewindableGenerator(function () {
            ...
            yield 0 => ($this->privates['.messenger.handler_descriptor.eYX89CA'] ?? $this->get_Messenger_HandlerDescriptor_EYX89CAService());
        }, 1)]));
    ...
    protected function getSecurity_Authentication_Provider_Guard_ApiService()
    {
        ...
        return $this->privates['security.authentication.provider.guard.api'] = new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(new RewindableGenerator(function () {
            yield 0 => ($this->privates['lexik_jwt_authentication.security.guard.jwt_token_authenticator'] ?? $this->getLexikJwtAuthentication_Security_Guard_JwtTokenAuthenticatorService());
        }, 1), ($this->privates['security.user.provider.concrete.app_user_provider'] ?? $this->getSecurity_User_Provider_Concrete_AppUserProviderService()), 'api', new \Symfony\Component\Security\Core\User\UserChecker(), ($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()));
    }
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            yield 'security.firewall.map.context.api' => ($this->privates['.security.request_matcher.kYb3JR_'] ?? ($this->privates['.security.request_matcher.kYb3JR_'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/back/')));
        }, 1));
    }
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'max_pagination': $value = $this->getEnv('MAX_PAGINATION'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'api_platform.title' => 'API Vuejsymf5',
            ...
            'api_platform.resource_class_directories' => [
                0 => (\dirname(__DIR__, 4).'/config/api_platform'),
            ],
